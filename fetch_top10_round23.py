"""
Round 23: AI Engineer / GenAI Engineer ONLY — 15 Results Target
CHANGES from previous rounds:
  - 1-WEEK window instead of 2 days (more results)
  - NO entry-level filter (many good roles don't tag this)
  - ONLY AI Engineer / GenAI keywords (no prompt engineering)
  - Tighter role whitelist focused on what user actually wants
"""
...
BLOCKED_ROLE_KEYWORDS = [
    "prompt engineer", "prompt engineering",  # USER EXPLICITLY DOES NOT WANT
    ...
    "consultant",  # usually requires experience
]
...
# ── Load ALL previous rounds to exclude URLs and roles ──
prev_files = [
    "top10_results.json",
    *[f"top10_round{i}_results.json" for i in range(2, 23)]
]
...
# ── Round 23: Focused AI Engineer / GenAI keywords only ──
SEARCH_KEYWORDS = [
    "AI Engineer fresher India",
    "GenAI Engineer India",
    "Generative AI Engineer India entry level",
    "Junior AI Engineer India",
    "AI Engineer intern India",
    "LLM Engineer India fresher",
    "AI ML Engineer India 0 experience",
    "Agentic AI Engineer India junior",
    "AI Developer Python India fresher",
    "GenAI Developer India junior",
    "AI Engineer startup India",
    "AI Engineer remote India",
    "Machine Learning Engineer fresher India",
    "AI Backend Engineer Python India",
    "NLP Engineer India entry level",
    "RAG Developer India",
    "AI Software Engineer India fresher",
...
def scrape_search_page(keyword, start=0):
    # KEY CHANGES:
    # 1. f_TPR=r604800 = 1 WEEK window (was 2 days)
    # 2. NO f_E=2 filter (was entry-level only, too restrictive)
    url = (
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 23 (Target: {TARGET} Results)")
    print(f"  1-WEEK Window | NO entry-level filter | AI/GenAI ONLY")
    ...
    output_file = "top10_round23_results.json"
