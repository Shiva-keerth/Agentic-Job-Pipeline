"""
Round 10: AI Engineer / GenAI ONLY pipeline.
...
- Excludes ALL jobs from Rounds 1-9.
- Focused AI Engineer keywords only — completely fresh set.
...
def analyze_apply_decision(missing_skills: list) -> tuple:
    """Returns (APPLY/SKIP, reason) based on missing skill type."""
...
# Round 10 — completely fresh AI Engineer focused keywords
SEARCH_KEYWORDS = [
    "AI engineer fresher Bengaluru 2026",
    "LangGraph developer junior India",
    "GenAI engineer associate Ahmedabad",
    "RAG developer fresher Mumbai 2026",
    "LLM engineer entry level Bengaluru",
    "agentic systems developer junior India",
    "AI Python engineer fresher immediate joiner",
    "NLP engineer junior Bengaluru 2026",
    "AI infrastructure engineer entry level India",
    "conversational AI engineer junior India",
    "AI product engineer associate India 2026",
    "machine learning Python engineer fresher Bengaluru",
]
...
def main():
    ...
    print(f"{'='*60}")
    print(f"  JOBLINE PIPELINE — ROUND 11 (AI Engineer / GenAI ONLY)")
    ...
    output_file = "top10_round11_results.json"
