"""
Round 22: AI Engineer / GenAI pipeline — 15 Results Target
Fresh keywords — all previous rounds 1-21 excluded
Targeting: AI Evaluation, LangGraph, Entry-level AI
"""
...
ALLOWED_ROLE_KEYWORDS = [
    ...
    "llmops", "mlops engineer", "ai platform engineer", "ai evaluation"
]
...
prev_files = [
    "top10_results.json",
    *[f"top10_round{i}_results.json" for i in range(2, 22)]
]
...
# ── Round 22: Brand new keyword angles ──
SEARCH_KEYWORDS = [
    "AI Evaluation Engineer India",
    "LLM Evaluation Developer India",
    "Prompt Engineer GenAI India entry level",
    "AI Agents Developer Python India",
    "Agentic AI Engineer Remote India",
    "Junior RAG Engineer India",
    "FastAPI Python GenAI India",
    "LLM API integration developer India",
    "AI product developer India fresher",
    "Generative AI backend python India",
    "Multi-agent AI developer India",
    "Claude API Python Developer India",
    "Gemini Streamlit developer India",
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 22 (Target: {TARGET} Results)")
    ...
    output_file = "top10_round22_results.json"
