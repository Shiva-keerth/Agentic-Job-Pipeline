"""
Round 28: AI Engineer / GenAI ONLY â€” 15 Results Target
- 24-HOUR Window, NO entry-level filter (experience pre-filter handles it)
- Excludes ALL 27 previous rounds
...
prev_files = [
    "top10_results.json",
    *[f"top10_round{i}_results.json" for i in range(2, 28)]
]
...
# â”€â”€ Round 28: FRESH keyword angles not used in R22/R23 â”€â”€
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE â€” ROUND 28 (Target: {TARGET} Results)")
    ...
    output_file = "top10_round28_results.json"
