"""
Round 24: AI Engineer / GenAI ONLY — 15 Results Target
- 1-WEEK window, NO entry-level filter (experience pre-filter handles it)
- Excludes ALL 23 previous rounds
- Fresh keyword angles: company-specific, tool-specific, role-variant searches
...
# ── Load ALL previous rounds (1 through 23) to exclude URLs and roles ──
prev_files = [
    "top10_results.json",
    *[f"top10_round{i}_results.json" for i in range(2, 24)]
]
...
# ── Round 24: FRESH keyword angles not used in R22/R23 ──
# Strategy: Mix company-targeted, tool-specific, and role-variant searches
SEARCH_KEYWORDS = [
    # Company-targeted (where AI freshers actually get hired)
    "AI Engineer Analyst Accenture India",
    "GenAI Developer TCS Infosys India",
    "AI Engineer Wipro HCL India fresher",
    # Tool-specific (match user's exact stack)
    "LangGraph AI Developer India",
    "RAG pipeline engineer Python India",
    "Vector database engineer India",
    "Groq API developer India",
    # Role variants not tried before
    "Trainee AI Engineer India",
    "Associate AI Engineer India",
    "AI Engineer graduate India 2025 2026",
    "GenAI Analyst India",
    "Conversational AI Engineer India",
    "AI Automation Engineer Python India",
    # Location-specific (Bangalore/Hyderabad/Remote hubs)
    "AI Engineer Bangalore fresher",
    "GenAI Engineer Hyderabad junior",
    "AI Developer remote work India",
    # Broader but still relevant
    "Python AI backend developer India junior",
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 24 (Target: {TARGET} Results)")
    print(f"  1-WEEK Window | Experience pre-filter | AI/GenAI ONLY")
    ...
    output_file = "top10_round24_results.json"
