"""
Round 27: AI Engineer / GenAI ONLY â€” 15 Results Target
- 24-HOUR Window, NO entry-level filter (experience pre-filter handles it)
- Excludes ALL 26 previous rounds
...
# â”€â”€ TIGHTER whitelist: Only roles user actually wants â”€â”€
...
# â”€â”€ Load ALL previous rounds (1 through 23) to exclude URLs and roles â”€â”€
prev_files = [
    "top10_results.json",
    *[f"top10_round{i}_results.json" for i in range(2, 27)]
]
...
# â”€â”€ Round 27: FRESH keyword angles not used in R22/R23 â”€â”€
# Strategy: Mix company-targeted, tool-specific, and role-variant searches
SEARCH_KEYWORDS = [
    "LLM Ops Engineer India",
    "Agentic AI Developer India",
    "Generative AI Backend Engineer India",
    "AI Applications Engineer India",
    "LangChain Python Developer India",
    "Junior Applied AI Engineer India",
    "GenAI Software Engineer India fresher",
    "LLM Integration Engineer India",
    "AI Product Engineer Python India",
    "FastAPI LLM backend India",
    "ChromaDB Vector Search Engineer India",
    "OpenAI API Python Developer India",
    "AI ML Engineer fresher 2025 India",
    "Junior GenAI Developer India",
    "Trainee Machine Learning Engineer GenAI India",
    "Associate Software Engineer AI India",
]
...
def analyze_apply_decision(missing_skills):
    if not missing_skills:
        return "APPLY", "No missing skills â€” perfect match!"
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE â€” ROUND 27 (Target: {TARGET} Results)")
    print(f"  24-HOUR Window | Experience pre-filter | AI/GenAI ONLY")
    ...
    for kw_idx, keyword in enumerate(SEARCH_KEYWORDS):
        ...
        for card in cards:
            ...
            if not role_ok:
                role_rejected += 1
                print(f"    [ROLE] '{title[:60]}' â€” {role_reason}")
                continue
    ...
    output_file = "top10_round27_results.json"
