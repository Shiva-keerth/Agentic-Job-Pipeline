"""
Round 20: AI Engineer / GenAI pipeline — 15 Results Target
Fresh keywords — all previous rounds 1-19 excluded
"""
...
prev_files = [
    ...
    *[f"top10_round{i}_results.json" for i in range(2, 20)]
]
...
# ── Round 20: Completely fresh keywords ──
SEARCH_KEYWORDS = [
    "Generative AI Python backend developer India",
    "AI systems integration engineer India fresher",
    "Junior AI RAG developer India",
    "LLM deployment engineer India",
    "AI application developer LangChain India",
    "Python software engineer AI capabilities India",
    "Applied machine learning software engineer India",
    "Agentic systems Python developer India",
    "FastAPI backend engineer AI India",
    "Junior AI prototype engineer India",
    "Generative AI solutions developer India",
    "Conversational AI software engineer India",
    "LLM inference orchestration engineer India",
    "AI full stack engineer Python India",
    "Junior prompt engineer Python India"
]
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 20 (Target: {TARGET} Results)")
    ...
    output_file = "top10_round20_results.json"
