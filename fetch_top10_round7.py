"""
Round 7: Scrape LinkedIn, evaluate via LLM, return 10 NEW qualified jobs.
- Excludes ALL jobs from Rounds 1–6.
...
EXCLUDE_COMPANIES = {
    ...
    # Round 6 companies explicitly blocked
...
# Fresh keywords for Round 7 — brand new set, no overlap with previous rounds
SEARCH_KEYWORDS = [
    "LangChain developer fresher India",
    "RAG engineer entry level 2026",
    "GenAI developer associate India",
    "AI engineer fresher Hyderabad",
    "AI engineer fresher Pune",
    "LLM engineer junior Bengaluru",
    "agentic AI developer 0 to 1 year",
    "NLP engineer associate India 2026",
    "AI software engineer trainee India",
    "Generative AI developer fresher Noida",
    "Python AI developer junior Chennai",
    "chatbot AI engineer fresher India",
]
...
def main():
    ...
    print(f"{'='*60}")
    print(f"  JOBLINE PIPELINE — ROUND 7 (2-Day Window)")
    ...
    print(f"\n\n{'='*60}")
    print(f"  FINAL RESULTS: {len(valid_jobs)} Qualified Jobs (Round 7 — 2-day)")
    print(f"{'='*60}\n")
    ...
    output_file = "top10_round7_results.json"
