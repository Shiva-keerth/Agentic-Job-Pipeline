"""
Round 16: AI Engineer / GenAI pipeline — 15 Results Target
Fresh keywords — all previous rounds 1-15 excluded
"""
...
prev_files = [
    ...
    *[f"top10_round{i}_results.json" for i in range(2, 16)]
]

EXCLUDE_COMPANIES = {
    "hcltech", "virtusa", "cognizant", "infosys", "strategic ventures-in",
    "wisdomai", "quest global", "centreax technologies",
    "honeywell", "accenture", "wipro", "tcs", "tata consultancy services",
    "tech mahindra", "mphasis", "ltimindtree", "hexaware",
    "unifiedai", "trkfly ai", "avix labs", "goldman sachs",
    "nxtwave", "capgemini", "lexsi labs", "mstack ai",
    "elevenlabs", "vahan.ai", "fello", "brillius technologies",
    ...
    "xlscout", "rudocode", "rooman technologies", "birlasoft",
    "ariedge", "workspeak", "streevia", "wealthnest.ai",
    "thermo fisher scientific", "zensar technologies", "zensar",
    "persistent systems", "niit technologies", "kpit technologies",
    "mastech digital", "cyient", "sasken", "sonata software",
    "meraki labs", "hrk global techsolutions pvt. ltd.",
    "hackerrank", "turing", "equal", "stance health", "tasks expert",
    "callkaro.ai", "iitmatrix", "setoo",
    "nuvama group", "softobiz", "clikkin", "iris software inc.",
    "blue machines ai", "nexus point", "ntt data north america",
    "coram ai", "softwareone", "kaseya", "comviva",
}
...
# ── Round 16: Completely fresh keywords ──
SEARCH_KEYWORDS = [
    "AI inference engineer India fresher",
    "LLM fine tuning engineer India entry level",
    "RAG pipeline developer India junior",
    "AI product developer India 2026",
    "Groq Llama developer India fresher",
    "AI automation developer India junior",
    "AI workflow developer Python India",
    "OpenAI GPT developer India entry level",
    "AI API developer India fresher 2026",
    "vector search engineer India junior",
    "knowledge graph developer Python India",
    "AI chatbot engineer India fresher",
    "multi agent AI developer India",
    "AI full stack engineer India fresher",
    "Python AI backend developer India startup",
]
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 16 (Target: {TARGET} Results)")
    ...
    output_file = "top10_round16_results.json"
