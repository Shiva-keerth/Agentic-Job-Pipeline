...
# ── Load ALL previous rounds (1 through 28) to exclude URLs and roles ──
prev_files = [
    "top10_results.json",
    *[f"top10_round{i}_results.json" for i in range(2, 29)]
]
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 29 (Target: {TARGET} Results)")
    ...
    output_file = "top10_round29_results.json"
