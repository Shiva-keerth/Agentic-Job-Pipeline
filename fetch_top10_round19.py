"""
Round 19: AI Engineer / GenAI pipeline — 15 Results Target
Fresh keywords — all previous rounds 1-18 excluded
"""
...
prev_files = [
    ...
    *[f"top10_round{i}_results.json" for i in range(2, 19)]
]
...
# ── Round 19: Completely fresh keywords ──
SEARCH_KEYWORDS = [
    "GenAI solutions engineer India",
    "AI software developer Python backend India",
    "Junior LLM integration engineer India",
    "LangChain AI developer India fresher",
    "Applied Generative AI engineer India",
    "AI logic builder Python India",
    "RAG systems engineer India entry level",
    "Agentic AI backend developer India",
    "Python foundation model developer India",
    "Junior AI inference engineer India",
    "FastAPI generative AI developer India",
    "Conversational AI API engineer India",
    "AI prototype builder India fresher",
    "Prompt engineering software developer India",
    "Junior RAG application developer India"
]
...
def main():
    ...
    print(f"{'='*62}")
    print(f"  JOBLINE PIPELINE — ROUND 19 (Target: {TARGET} Results)")
    ...
    output_file = "top10_round19_results.json"
